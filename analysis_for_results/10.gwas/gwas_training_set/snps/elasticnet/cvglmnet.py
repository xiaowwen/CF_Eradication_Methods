...
OUTPUT ARGUMENTS:
 ...
 % Parallel
    ...
    cvglmnet(x,y,[],[],[],[],[],true);
    toc;
    # /home/enaziga/anaconda3/lib/python3.6/site-packages/glmnet_python/cvglmnet.py
    # Had to change line 260 from:
    ...
    Seems line interger recasting is neccessary for line to work
