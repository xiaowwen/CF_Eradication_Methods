...
n_estimators = [int(x) for x in np.linspace(start = 100, stop = 10000, num = 50)]
...
hyperparameters(classifier=RTClassifier, X=X, y=y, grid=random_grid, iterations=10000, fold=4)
